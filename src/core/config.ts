  ...
  public validate(): void {
    ...
    if (!this.google.callbackURL) {
      throw new ZoogleConfigError(
        ...
        'Provide a callback URL (e.g. http://localhost:3000/auth/google/callback) and add it to your Google OAuth settings as an Authorized redirect URI.',
      );
    }
    ...
    if (this.google.clientId && placeholderPattern.test(this.google.clientId)) {
      ...
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.warn(
        'It appears you are using a placeholder Google Client ID (contains YOUR_ or CHANGE_ME).',
      );
      console.warn(
        'This will not work in production. Obtain a real Client ID from Google Cloud Console and set it in your environment.',
      );
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    }
    ...
    if (
      this.google.clientSecret &&
      placeholderPattern.test(this.google.clientSecret)
    ) {
      console.warn(
      ...
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.warn(
        'It appears you are using a placeholder Google Client Secret. Replace it with the real secret from Google Cloud Console.',
      );
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    }
    ...
    if (weakSecrets.includes(secretLower)) {
      ...
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.warn(
        'Using a weak JWT secret is insecure. Generate a strong random secret:',
      );
      console.warn(
    ...
    if (
      ...
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.warn(
        'OAuth redirect URIs should use https:// in production to avoid token interception.',
      );
      console.warn(
        'Please update your callbackURL to use HTTPS and update your Google Cloud Console settings.',
      );
      console.warn('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    }
  }
